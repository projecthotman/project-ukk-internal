            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card mb-4 text-white bg-primary">
                    <div class="card-body pb-0 d-flex justify-content-between align-items-start">
                        <div>
                            <div class="fs-4 fw-semibold">{{ 'Rp ' . number_format($user->saldo, 0, ',', '.') }}<span class="fs-6 fw-normal"> (-12.4%
                                    <svg class="icon">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item"
                                    href="#">Action</a><a class="dropdown-item" href="{{ route('topUp') }}">Isi Ulang</a><a class="dropdown-item" href="#">Something else here</a>
                            </div>
                        </div>
                    </div>
