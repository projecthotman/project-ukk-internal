<div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
    ...
    <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
        ...
        <li class="nav-item"><a class="nav-link" href="{{ route('pendapatan') }}">
            <svg class="nav-icon">
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            ...
            <ul class="nav-group-items">
                <li class="nav-item"><a class="nav-link" href="{{ route('index-transaksi-pembelian') }}"><span
                            class="nav-icon"></span>
                        Pembelian</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ route('index-transaksi-penjualan') }}"><span
                            class="nav-icon"></span>
                        Penjualan</a></li>
            </ul>
        </li>
        ...
        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#">
            ...
            <ul class="nav-group-items">
                <li class="nav-item"><a class="nav-link" href="{{ route('index-barang-beli') }}"><span
                            class="nav-icon"></span>
                        Gudang</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ route('index-barang-jual') }}"><span
                            class="nav-icon"></span>
                        Post</a></li>
            </ul>
        </li>
        ...
        @guest
            <li class="nav-item">
                <a class="nav-link nav-link-danger" href="{{ route('login-view') }}" target="_top">
                    <svg class="nav-icon">
            ...
            <li class="nav-item">
                <a class="nav-link nav-link-danger" href="{{ route('register-view') }}" target="_top">
                    <svg class="nav-icon">
                        <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-layers"></use>
                    </svg> Register
                </a>
